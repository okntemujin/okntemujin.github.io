  const translations = {
    mn: {
      ...
      about_p1: "Би Калифорнийн Беркли Их Сургуулийн доктрантурын (PhD) оюутан бөгөөд квант химийн чиглэлээр судалгаа хийхийг зорьж байна.",
      ...
      contact_lede: "Хэрэв та гадаадын иx сургуулийн баклавар болон доктрантурт өргөдөл явуулаx, химийн төрөл бүрийн олимпиадад бэлдэx, хими, физик, биологи, математикийн хичээлийн тусламж хэрэгтэй бол доорх имэйл хаягаар холбогдоно уу.",
