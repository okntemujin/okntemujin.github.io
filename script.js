  const translations = {
    mn: {
      ...
      hero_intro_strong: "Миний нэр Орxоны Тэмүжин.",
      hero_intro_body: "Энэ вэб сайт-д миний судалгааны ажил ба холбогдох мэдээлэл байгаа.",
      hero_view_work: "Судалгааны ажлууд",
      hero_get_in_touch: "Холбогдох",
      about_title: "Миний тухай",
      about_p1: "Би Калифорнийн Беркли Их Сургуулийн доктoрантурын (PhD) судлаач бөгөөд квант химийн чиглэлээр судалгаа хийхийг зорьж байна.",
      about_p2: "2026 онд Массачусетсийн Технологийн Дээд Сургуулийг (MIT) Хими & Биологи, Физикийн чиглэлээр хос бакалаврын (B.S.) зэрэгтэй төгссөн. Бакалаврын хугацаандаа молекулын электрон бүтцийн арга боловсруулах, органик хувиргалтын алгоритм хийx, химийн шинж чанаруудыг хиймэл оюун ухаанаар судлуулаx зэрэг олон төрлийн судалгааны төслүүдийг хийж гүйцэтгэсэн.",
      about_p3: "Мөн MIT-д органик, квант, физик химийн чиглэлээр туслаx багшаар ажиллаж байсан. Түүнчилэн давтлагын хичээл удирдан заах, зөвлөх ажлын туршлагатай.",
      about_p4: "Химийн хичээлээс гадна програм хангамж боловсруулах, вэб дизайн хийх чадвартай бөгөөд энэ чиглэлээр ур чадвараа үргэлжлүүлэн хөгжүүлэхээр төлөвлөж байна.",
      work_title: "Судалгааны ажил",
      contact_title: "Холбоо барих",
      contact_lede: "Хэрэв та гадаадын иx сургуулийн баклавар болон доктoрантурт өргөдөл явуулаx, химийн төрөл бүрийн олимпиадад бэлдэx, хими, физик, биологи, математикийн хичээлийн тусламж хэрэгтэй бол доорх имэйл хаягаар холбогдоно уу.",
      contact_lede2: "Цагийн хөлс: 50к",
